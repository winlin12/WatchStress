...
final class DashboardViewModel: ObservableObject {
    ...
    @MainActor
    func start() async {
        // Placeholder: later we will kick off HealthKit reads and update as data arrives.
        // For now, simulate data arrival in a non-blocking way.
        await Task.sleep(NSEC_PER_SEC / 2)
        update(restingHR: 62, hrvSDNN: nil, respiratoryRate: 16, sleepHours: 6.8)
    }
